...
$(function () {
    // いいね！がクリックされたとき
    $('.js-like').click(function () { //js-likeクラスがクリックされたとき
        const this_obj = $(this);
        ...
        if (like_id) {
            ...
            .done(() => { // 無名関数
                //いいね！カウントを減らす
                like_count--; //like_countを１減らす
                like_count_obj.html(like_count);//HTMLにセット
            ...
            .done((data) => {
                // いいね！カウントを増やす
                like_count++; //like_countを１増やす
                like_count_obj.html(like_count);//HTMLをセット
